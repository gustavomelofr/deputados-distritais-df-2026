...
- [!] Adicionar notícias verificadas até atingir 100 registros válidos.
  ...
  Bloqueio: escalonamento humano solicitado pelo orquestrador/verifier — instrução explícita de não fazer novas mudanças até revisão humana.
  Ação humana necessária: revisar o lote atual de notícias (registros 96–100) e autorizar a retomada da adição de notícias verificadas até atingir 100 registros válidos.
