            ...
            <div className="mt-4 flex flex-wrap items-center gap-3">
              {dep.contatos.instagram && (
                <a
                  ...
                  className="inline-flex items-center gap-1.5 rounded-full bg-pink-50 text-pink-700 text-sm font-medium px-3 py-1 hover:bg-pink-100 transition"
                >
              ...
              {dep.contatos.twitter && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 rounded-full bg-sky-50 text-sky-700 text-sm font-medium px-3 py-1 hover:bg-sky-100 transition"
                >
                  <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor" aria-hidden="true">
              ...
              {dep.contatos.email && (
                <a
                  ...
                  className="inline-flex items-center gap-1.5 rounded-full bg-zinc-100 text-zinc-700 text-sm font-medium px-3 py-1 hover:bg-zinc-200 transition"
                >
