...
export const cenarioEleitoral: PessoaEleitoral[] = [
  ...
  //    Federação União Progressista em convenção de 2 de agosto de 2026.
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-celina-leao-convencao-pl-2026-08-02',
        pessoaId: 'celina-leao',
        cargo: 'governador',
        estagio: 'anunciado_pelo_partido',
        partido: 'PP',
        fonte: 'G1',
        fonteCategoria: 'veiculo_jornalistico',
        url: 'https://g1.globo.com/df/distrito-federal/eleicoes/2026/noticia/2026/08/02/pl-oficializa-bia-kicis-e-michelle-bolsonaro-como-candidatas-ao-senado-pelo-distrito-federal.ghtml',
        descricao:
          'O PL aclamou a governadora Celina Leão (PP) como candidata à reeleição ao GDF durante convenção realizada em 2 de agosto de 2026 em Brasília, confirmando o apoio do partido à sua candidatura na mesma chapa que oficializou Bia Kicis e Michelle Bolsonaro ao Senado.',
        dataEvidencia: '2026-08-02',
  ...
  //    homologado pela Federação Brasil da Esperança (PT-PV-PCdoB).
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-leandro-grass-adiamento-convencao-2026-08-04',
        pessoaId: 'leandro-grass',
        cargo: 'governador',
        ...
        fonte: 'G1',
        fonteCategoria: 'veiculo_jornalistico',
        url: 'https://g1.globo.com/df/distrito-federal/eleicoes/2026/noticia/2026/08/04/psb-e-pt-seguem-separados-no-df-capelli-pede-bom-senso-e-grass-adia-convencao-para-ampliar-frente.ghtml',
        descricao:
          'A Federação Brasil da Esperança (PT, PV e PCdoB) transferiu sua convenção, marcada para 4 de agosto de 2026, para 5 de agosto (prazo final), com o objetivo declarado de ampliar a frente progressista; o DF é a única unidade da Federação em que PSB e PT não estão coligados.',
        dataEvidencia: '2026-08-04',
        coletadaEm: '2026-08-04',
        verificadaEm: '2026-08-04',
      },
      {
        id: 'e-leandro-grass-convencao-pt-2026-08-05',
        pessoaId: 'leandro-grass',
        cargo: 'governador',
        estagio: 'anunciado_pelo_partido',
        partido: 'PT',
        fonte: 'G1',
        fonteCategoria: 'veiculo_jornalistico',
        url: 'https://g1.globo.com/df/distrito-federal/eleicoes/2026/noticia/2026/08/05/pt-lanca-leandro-grass-ao-governo-do-distrito-federal-e-erika-kokay-ao-senado.ghtml',
        descricao:
          'O PT confirmou, em convenção realizada em 5 de agosto de 2026 em Brasília (prazo final das convenções), a candidatura de Leandro Grass ao governo do Distrito Federal; a Federação Brasil da Esperança (PT, PV e PCdoB) anunciou Dora Gomes (PV) como candidata à vice-governadoria na chapa, e PDT, PSOL e Rede declararam apoio à chapa.',
        dataEvidencia: '2026-08-05',
        coletadaEm: '2026-08-06',
        verificadaEm: '2026-08-06',
      },
    ],
    coletadaEm: '2026-08-06',
    verificadaEm: '2026-08-06',
  ...
  //    conflitante de Tetê Monteiro pela Federação PSOL-Rede.
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-dora-gomes-convencao-pt-2026-08-05',
        pessoaId: 'dora-gomes',
        cargo: 'vice_governador',
        estagio: 'anunciado_pelo_partido',
        partido: 'PV',
        ...
        url: 'https://g1.globo.com/df/distrito-federal/eleicoes/2026/noticia/2026/08/05/pt-lanca-leandro-grass-ao-governo-do-distrito-federal-e-erika-kokay-ao-senado.ghtml',
        descricao:
          'A Federação Brasil da Esperança (PT, PV e PCdoB) anunciou, em convenção realizada em 5 de agosto de 2026, Dora Gomes (PV) como candidata à vice-governadoria na chapa de Leandro Grass ao GDF, confirmando a indicação do PV-DF.',
        dataEvidencia: '2026-08-05',
        coletadaEm: '2026-08-06',
        verificadaEm: '2026-08-06',
      },
  ...
  //    com convenção marcada para 3 de agosto.
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-cappelli-executiva-psb-2026-07-30',
        pessoaId: 'ricardo-cappelli',
        cargo: 'governador',
        estagio: 'anunciado_pelo_partido',
        partido: 'PSB',
        ...
        fonteCategoria: 'veiculo_jornalistico',
        url: 'https://blogdoamarildo.com.br/executiva-do-psb-df-aprova-por-unanimidade-resolucao-com-indicacao-de-cappelli-para-disputar-o-gdf/',
        descricao:
          'A Executiva do PSB-DF aprovou por unanimidade, em 30 de julho de 2026, resolução com a indicação de Ricardo Cappelli para disputar o GDF, a ser oficializada em convenção da legenda marcada para 3 de agosto de 2026 no auditório da ADUnB.',
        dataEvidencia: '2026-07-30',
        coletadaEm: '2026-08-03',
        verificadaEm: '2026-08-03',
      },
      {
        id: 'e-cappelli-convencao-psb-2026-08-03',
        pessoaId: 'ricardo-cappelli',
        cargo: 'governador',
        estagio: 'anunciado_pelo_partido',
        partido: 'PSB',
        fonte: 'G1',
        fonteCategoria: 'veiculo_jornalistico',
        url: 'https://g1.globo.com/df/distrito-federal/eleicoes/2026/noticia/2026/08/03/psb-oficializa-ricardo-cappelli-como-candidato-ao-governo-do-distrito-federal.ghtml',
        descricao:
          'O PSB confirmou a candidatura de Ricardo Cappelli ao governo do Distrito Federal em convenção realizada em 3 de agosto de 2026 em Brasília; o partido não anunciou o candidato a vice-governador nem lançou candidaturas ao Senado.',
  ...
  //     reportagens independentes; convenção prevista para 4 de agosto.
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-paula-belmonte-convencao-solidariedade-prd-2026-08-02',
        pessoaId: 'paula-belmonte',
        cargo: 'governador',
        estagio: 'anunciado_pelo_partido',
        partido: 'PSDB',
        fonte: 'Correio Braziliense',
        fonteCategoria: 'veiculo_jornalistico',
        url: 'https://www.correiobraziliense.com.br/cidades-df/2026/08/7472525-e-para-mudar-o-destino-de-brasilia-diz-paula-belmonte-em-convencao.html',
        descricao:
          'Paula Belmonte (PSDB), candidata ao GDF, discursou em convenção partidária dos partidos Solidariedade e PRD em 2 de agosto de 2026, afirmando que o objetivo é "mudar o destino de Brasília" e elogiando o ex-senador Reguffe presente ao evento.',
        dataEvidencia: '2026-08-02',
        coletadaEm: '2026-08-03',
        verificadaEm: '2026-08-03',
      },
  ...
  //     do Partido Novo.
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-caputo-convencao-novo-2026-07-31',
        pessoaId: 'kiko-caputo',
        cargo: 'governador',
        estagio: 'anunciado_pelo_partido',
        partido: 'Novo',
        fonte: 'Correio Braziliense',
        fonteCategoria: 'veiculo_jornalistico',
        url: 'https://www.correiobraziliense.com.br/cidades-df/2026/07/7471979-novo-oficializa-kiko-caputo-para-concorrer-ao-gdf-e-coelho-ao-senado.html',
        descricao:
          'O Partido Novo oficializou, em convenção realizada em 31 de julho de 2026 em Brasília, a candidatura do advogado e ex-presidente da OAB-DF Kiko Caputo ao Governo do Distrito Federal; o nome do vice ainda não estava definido.',
        dataEvidencia: '2026-07-31',
        coletadaEm: '2026-08-03',
        verificadaEm: '2026-08-03',
      },
    ],
  ...
  //     Esperança e da Federação PSOL-Rede.
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-leila-barros-convencao-pdt-2026-08-04',
        pessoaId: 'leila-barros',
        cargo: 'senador',
        estagio: 'movimentacao_publica',
        partido: 'PDT',
        fonte: 'Metrópoles',
        fonteCategoria: 'veiculo_jornalistico',
        url: 'https://www.metropoles.com/colunas/grande-angular/pt-psdb-e-pdt-encerram-maratona-de-convencoes-no-df',
        descricao:
          'O PDT-DF realizaria convenção em 4 de agosto de 2026, na sede da legenda, na qual a senadora Leila do Vôlei disputará a reeleição ao Senado; o partido também deverá anunciar posição sobre o GDF.',
        dataEvidencia: '2026-08-04',
        coletadaEm: '2026-08-04',
        verificadaEm: '2026-08-04',
      },
  ...
  //     Esperança (PT-PV-PCdoB).
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-erika-kokay-adiamento-convencao-2026-08-04',
        pessoaId: 'erika-kokay',
        cargo: 'senador',
        estagio: 'movimentacao_publica',
        partido: 'PT',
        ...
        url: 'https://www.metropoles.com/colunas/grande-angular/pt-psdb-e-pdt-encerram-maratona-de-convencoes-no-df',
        descricao:
          'A Federação Brasil da Esperança (PT, PV e PCdoB) confirmará Erika Kokay como candidata ao Senado na convenção remarcada para 5 de agosto de 2026, após adiamento da data original de 4 de agosto.',
        dataEvidencia: '2026-08-04',
        coletadaEm: '2026-08-04',
        verificadaEm: '2026-08-04',
      },
      {
        id: 'e-erika-kokay-convencao-pt-2026-08-05',
        pessoaId: 'erika-kokay',
        cargo: 'senador',
        estagio: 'anunciado_pelo_partido',
        partido: 'PT',
        ...
        url: 'https://g1.globo.com/df/distrito-federal/eleicoes/2026/noticia/2026/08/05/pt-lanca-leandro-grass-ao-governo-do-distrito-federal-e-erika-kokay-ao-senado.ghtml',
        descricao:
          'O PT confirmou, em convenção realizada em 5 de agosto de 2026 em Brasília, a candidatura de Erika Kokay (PT) ao Senado pelo Distrito Federal; a parlamentar cumpre atualmente o quarto mandato como deputada federal e disputará uma vaga no Senado pela primeira vez.',
        dataEvidencia: '2026-08-05',
        coletadaEm: '2026-08-06',
        verificadaEm: '2026-08-06',
      },
  ...
  //     cobertura posterior do partido.
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-bia-kicis-convencao-pl-2026-08-02',
        pessoaId: 'bia-kicis',
        cargo: 'senador',
        estagio: 'anunciado_pelo_partido',
        partido: 'PL',
        ...
        url: 'https://g1.globo.com/df/distrito-federal/eleicoes/2026/noticia/2026/08/02/pl-oficializa-bia-kicis-e-michelle-bolsonaro-como-candidatas-ao-senado-pelo-distrito-federal.ghtml',
        descricao:
          'O PL oficializou, em convenção realizada em 2 de agosto de 2026 em Brasília, a candidatura da deputada federal Bia Kicis (PL-DF), presidente do diretório distrital, ao Senado pelo Distrito Federal, compondo chapa pura com Michelle Bolsonaro; o partido também confirmou apoio à reeleição da governadora Celina Leão (PP).',
        dataEvidencia: '2026-08-02',
        coletadaEm: '2026-08-03',
        verificadaEm: '2026-08-03',
      },
  ...
  //     agosto de 2026, com oficialização na convenção do PL.
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-michelle-bolsonaro-convencao-pl-2026-08-02',
        pessoaId: 'michelle-bolsonaro',
        cargo: 'senador',
        estagio: 'anunciado_pelo_partido',
        partido: 'PL',
        ...
        url: 'https://g1.globo.com/df/distrito-federal/eleicoes/2026/noticia/2026/08/02/pl-oficializa-bia-kicis-e-michelle-bolsonaro-como-candidatas-ao-senado-pelo-distrito-federal.ghtml',
        descricao:
          'O PL oficializou, em convenção realizada em 2 de agosto de 2026 em Brasília, a candidatura da ex-primeira-dama Michelle Bolsonaro ao Senado pelo Distrito Federal, em chapa pura com Bia Kicis; esta é a primeira candidatura eleitoral de Michelle Bolsonaro, que não compareceu ao evento por motivo de saúde.',
        dataEvidencia: '2026-08-02',
        coletadaEm: '2026-08-03',
        verificadaEm: '2026-08-03',
      },
  ...
  //     oficializado em convenção estadual em 20 de julho de 2026.
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-sebastiao-coelho-convencao-novo-2026-07-31',
        pessoaId: 'sebastiao-coelho',
        cargo: 'senador',
        estagio: 'anunciado_pelo_partido',
        partido: 'Novo',
        ...
        url: 'https://www.correiobraziliense.com.br/cidades-df/2026/07/7471979-novo-oficializa-kiko-caputo-para-concorrer-ao-gdf-e-coelho-ao-senado.html',
        descricao:
          'O Partido Novo confirmou, em convenção realizada em 31 de julho de 2026 em Brasília, o desembargador aposentado Sebastião Coelho como candidato ao Senado Federal pelo DF, na mesma chapa que oficializou Kiko Caputo ao GDF.',
        dataEvidencia: '2026-07-31',
        coletadaEm: '2026-08-03',
        verificadaEm: '2026-08-03',
      },
  ...
  //     anunciado pelo PSB-DF.
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-cristovam-buarque-convencao-psb-2026-08-03',
        pessoaId: 'cristovam-buarque',
        cargo: 'deputado_federal',
        estagio: 'anunciado_pelo_partido',
        partido: 'PSB',
        fonte: 'TV DF Comunitária',
        fonteCategoria: 'veiculo_jornalistico',
        url: 'https://www.tvdfcomunitaria.com.br/2026/08/04/capelli-confirma-candidatura-ao-gdf-vou-lutar-ate-dia-15-pela-unidade-do-nosso-campo/',
        descricao:
          'A convenção do PSB-DF em 3 de agosto de 2026 marcou a confirmação das candidaturas ao Legislativo, incluindo o ex-governador Cristovam Buarque como candidato a deputado federal.',
        dataEvidencia: '2026-08-03',
        coletadaEm: '2026-08-04',
        verificadaEm: '2026-08-04',
      },
  ...
  //     disputa ao GDF e confirmou candidatura à Câmara.
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-izalci-lucas-nominata-pl-2026-08-02',
        pessoaId: 'izalci-lucas',
        cargo: 'deputado_federal',
        estagio: 'anunciado_pelo_partido',
        partido: 'PL',
        fonte: 'Blog da Cris',
        fonteCategoria: 'veiculo_jornalistico',
        url: 'https://blogdacris.com.br/distrito-federal/pl-aclama-celina-leao-ao-gdf-confirma-michelle-bolsonaro-e-bia-kicis-ao-senado-e-apresenta-nominatas-para-2026/',
        descricao:
          'O PL homologou, em convenção realizada em 2 de agosto de 2026, a nominata para a Câmara dos Deputados pelo DF, incluindo Izalci Lucas entre os 12 pré-candidatos a deputado federal apresentados pelo partido.',
        dataEvidencia: '2026-08-02',
        coletadaEm: '2026-08-03',
        verificadaEm: '2026-08-03',
      },
  ...
  //     anunciado pelo PSB-DF.
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-rodrigo-rollemberg-convencao-psb-2026-08-03',
        pessoaId: 'rodrigo-rollemberg',
        cargo: 'deputado_federal',
        estagio: 'anunciado_pelo_partido',
        partido: 'PSB',
        ...
        url: 'https://www.tvdfcomunitaria.com.br/2026/08/04/capelli-confirma-candidatura-ao-gdf-vou-lutar-ate-dia-15-pela-unidade-do-nosso-campo/',
        descricao:
          'A convenção do PSB-DF em 3 de agosto de 2026 marcou a confirmação das candidaturas ao Legislativo, incluindo o ex-governador Rodrigo Rollemberg como candidato a deputado federal.',
        dataEvidencia: '2026-08-03',
        coletadaEm: '2026-08-04',
        verificadaEm: '2026-08-04',
      },
  ...
  //     dos Deputados, conforme reportagem do Brasil de Fato DF; homologado na
  //     nominata do PL para deputado federal em convenção de 2 de agosto de
  //     2026 (estágio atualizado para anunciado_pelo_partido, preservando o
  //     histórico anterior de movimentação pública).
  {
    id: 'thiago-manzoni',
    slug: 'thiago-manzoni',
    nome: 'Thiago Manzoni',
    ...
    evidencias: [
      ...
      {
        id: 'e-thiago-manzoni-nominata-pl-2026-08-02',
        pessoaId: 'thiago-manzoni',
        cargo: 'deputado_federal',
        estagio: 'anunciado_pelo_partido',
        partido: 'PL',
        ...
        url: 'https://blogdacris.com.br/distrito-federal/pl-aclama-celina-leao-ao-gdf-confirma-michelle-bolsonaro-e-bia-kicis-ao-senado-e-apresenta-nominatas-para-2026/',
        descricao:
          'O PL homologou, em convenção realizada em 2 de agosto de 2026, a nominata para a Câmara dos Deputados pelo DF, incluindo o deputado distrital Thiago Manzoni (PL) entre os 12 pré-candidatos a deputado federal apresentados pelo partido.',
        dataEvidencia: '2026-08-02',
        coletadaEm: '2026-08-03',
        verificadaEm: '2026-08-03',
      },
  ...
  //     confirmado em convenção do MDB-DF em 1º de agosto de 2026.
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-rafael-prudente-convencao-mdb-jornalbrasilia-2026-08-01',
        pessoaId: 'rafael-prudente',
        cargo: 'deputado_federal',
        estagio: 'anunciado_pelo_partido',
        partido: 'MDB',
        fonte: 'Jornal de Brasília',
        fonteCategoria: 'veiculo_jornalistico',
        url: 'https://jornaldebrasilia.com.br/brasilia/com-presenca-de-celina-mdb-df-realiza-convencao/',
        descricao:
          'O MDB-DF confirmou, em convenção realizada em 1º de agosto de 2026 com a presença da governadora Celina Leão, os nomes dos candidatos a deputado federal e distrital; Rafael Prudente manteve a candidatura à reeleição à Câmara dos Deputados, deixando em aberto a possibilidade de migrar para a disputa ao Senado conforme definições do PL-DF.',
        dataEvidencia: '2026-08-01',
        coletadaEm: '2026-08-03',
        verificadaEm: '2026-08-03',
      },
  ...
  //     movimentação pública pelo caráter condicional declarado pela própria.
  {
    ...
    evidencias: [
      ...
      {
        id: 'e-mayara-noronha-rocha-convencao-podemos-soubrasilia-2026-08-01',
        pessoaId: 'mayara-noronha-rocha',
        cargo: 'deputado_federal',
        estagio: 'movimentacao_publica',
        partido: 'Podemos',
        fonte: 'Sou Brasília',
        fonteCategoria: 'veiculo_jornalistico',
        url: 'https://soubrasilia.com/podemos-df-apoio-celina-leao-cristian-viana-senado/',
        descricao:
          'O Podemos-DF oficializou, em convenção realizada em 1º de agosto de 2026 no Minas Hall, o apoio à reeleição de Celina Leão e o lançamento de Cristian Viana ao Senado; a legenda homologou 25 candidaturas à Câmara Legislativa e nove à Câmara dos Deputados, incluindo Mayara Noronha Rocha.',
        dataEvidencia: '2026-08-01',
        coletadaEm: '2026-08-03',
        verificadaEm: '2026-08-03',
      },
